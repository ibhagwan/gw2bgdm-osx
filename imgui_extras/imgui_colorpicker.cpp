...
static inline const char*      FindTextDisplayEnd(const char* text, const char* text_end = NULL);

// Find the optional ## from which we stop displaying text.
static inline const char*  FindTextDisplayEnd(const char* text, const char* text_end)
{
