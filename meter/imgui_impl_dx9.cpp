...
#include "imgui_extras/imgui_freetype.h"
#endif
...
void ImGui_ImplDX9_NewFrame(void *vp)
{
	if (!g_FontTexture)
	...
	if (!vp) {
		...
		D3DVIEWPORT9* viewPort = (D3DVIEWPORT9*)vp;
		io.DisplaySize = ImVec2((float)viewPort->Width, (float)viewPort->Height);
	}
